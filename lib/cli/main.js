...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `gltcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ gltcore-node add wallet-service');
      console.log('    $ gltcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ gltcore-node remove wallet-service');
      console.log('    $ gltcore-node remove insight-api');
      console.log();
    });
